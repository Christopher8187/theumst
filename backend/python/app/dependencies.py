...
def current_user(request: Request) -> dict[str, Any] | None:
    # Authentication is DB-backed and must be revalidated once per request,
    # but protected-response middleware and the endpoint must share that exact
    # result instead of consuming multiple connections and policy snapshots.
