...
Read [desktop navigation and entry URLs](../../docs/architecture/frontend.md#desktop-navigation-and-entry-urls) before changing window navigation or account links. `composables/desktopEntry.js` captures compatibility paths and queries before normalizing the address; `DesktopApp.vue` passes the captured account data to the appropriate form.
