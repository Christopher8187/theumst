...
const en = {
  ...
  project: "Project", cluster: "Cluster", book: "Book", graph: "Graph", close: "Close", closeSimilar: "Close Cluster",
  ...
  noteConstellation: "Note constellation", allNotes: "All notes", delete: "Delete",
  embeddingSearch: "Related ideas", similarityMethod: "Nearby ideas from this book, ordered by how closely they relate to what you are studying. No new answer is generated.",
  noResults: "No closely related knowledge was found in this book.", loadingSimilar: "Building the Cluster…",
  similarPrompt: "Choose Cluster to look for nearby knowledge in this book.", similarResults: "Cluster results",
  similarityStrength: "Match", similarUnavailable: "Cluster is not available right now.",
  similarError: "Cluster could not be loaded. Please try again.", graphError: "This part of the knowledge map could not be loaded.",
  ...
  promptSoon: "AI prompting is coming soon.", projectSoon: "Projection search is coming soon.", selectNode: "Select a knowledge item to study it.",
...
const zh = {
  ...
  text: "正文", notes: "笔记", questions: "问题", train: "训练", preview: "预览", progress: "进度", project: "投射", cluster: "Cluster", book: "书籍", graph: "图谱", close: "关闭", closeSimilar: "关闭 Cluster",
  ...
  scribbles: "随笔", attachedNotes: "关联笔记", notePlaceholder: "记录想法、联系或问题…", noteConstellation: "笔记星图", allNotes: "全部笔记", delete: "删除", embeddingSearch: "相关概念", similarityMethod: "本书中的邻近概念会根据与当前学习内容的相关程度排序。不会生成新的答案。", noResults: "本书中没有找到密切相关的知识。", loadingSimilar: "正在构建 Cluster…", similarPrompt: "选择 Cluster 以浏览本书中的邻近知识。", similarResults: "Cluster 结果", similarityStrength: "匹配度", similarUnavailable: "Cluster 目前不可用。", similarError: "无法加载 Cluster，请重试。", graphError: "无法加载知识图的这一部分。",
  returnOrigin: "返回原始书籍", questionMode: "习题路径", textMode: "知识路径", notesMode: "学者书案", bookwork: "书本知识", sectionPath: "章节路径", searchGrimoires: "搜索魔典", open: "打开", language: "语言", emptySearch: "没有匹配的书籍。", saved: "已保存", soundSoon: "音频播放即将推出。", promptSoon: "AI 提示即将推出。", projectSoon: "投射搜索即将推出。", selectNode: "选择一项知识内容开始学习。", questionSymbol: "待解问题", bookSymbol: "来源书本", notesHelp: "关联笔记依附知识；随笔跨书籍归属于你。", startWriting: "选择笔记或新建随笔。",
...
const ja = {
  ...
  text: "本文", notes: "ノート", questions: "問題", train: "訓練", preview: "プレビュー", progress: "進捗", project: "投影", cluster: "Cluster", book: "書籍", graph: "グラフ", close: "閉じる", closeSimilar: "Cluster を閉じる", statement: "命題", workings: "導出", prompt: "プロンプト", listen: "音声", markDone: "完了にする", completed: "完了", previous: "前へ", next: "次へ", knowledge: "知識", tag: "タグ", saveNote: "ノート保存", newScribble: "新しい走り書き", scribbles: "走り書き", attachedNotes: "関連ノート", notePlaceholder: "アイデア、つながり、疑問を記録…", noteConstellation: "ノート星座", allNotes: "すべてのノート", delete: "削除", embeddingSearch: "関連するアイデア", similarityMethod: "この本の中で、学習中の内容との関連が強い順に近いアイデアを表示します。新しい回答は生成されません。", noResults: "この本では密接に関連する知識が見つかりませんでした。", loadingSimilar: "Cluster を構築中…", similarPrompt: "Cluster を選ぶと、この本の近い知識を探せます。", similarResults: "Cluster の結果", similarityStrength: "一致度", similarUnavailable: "Cluster は現在利用できません。", similarError: "Cluster を読み込めませんでした。もう一度お試しください。", graphError: "知識マップのこの部分を読み込めませんでした。", returnOrigin: "元の本に戻る", questionMode: "演習ルート", textMode: "知識ルート", notesMode: "学者の机", bookwork: "本文", sectionPath: "章の経路", searchGrimoires: "グリモアを検索", open: "開く", language: "言語", emptySearch: "一致する書籍はありません。", saved: "保存しました", soundSoon: "音声再生は近日公開です。", promptSoon: "AI プロンプトは近日公開です。", projectSoon: "投影検索は近日公開です。", selectNode: "学習する知識項目を選んでください。", questionSymbol: "解く問題", bookSymbol: "出典", notesHelp: "関連ノートは知識に付き、走り書きは書籍を越えて保存されます。", startWriting: "ノートを選ぶか走り書きを作成してください。", realmText: "書籍順に構造化知識を読みます。", realmNotes: "関連ノートと走り書きを整理します。", realmQuestions: "文脈とともに演習を進めます。", realmExpand: "より広い接続を探索します。", realmReview: "補強が必要な内容へ戻ります。", realmPreview: "位置を失わず先を見ます。", realmAdvice: "学習助言を受けます。", realmProgress: "習熟度の成長を確認します。"
};

const es = { ...en, exit: "Salir", mainMenu: "Menú principal", back: "Volver", library: "Biblioteca arcana", searchBooks: "Buscar por título", recommended: "Recomendados", comingSoon: "Este reino estará disponible pronto.", aiSummary: "Resumen de IA", contents: "Contenido", summon: "Invocar grimorio", grimoires: "Mis grimorios", text: "Texto", notes: "Notas", questions: "Preguntas", progress: "Progreso", statement: "Enunciado", workings: "Desarrollo", markDone: "Marcar como hecho", completed: "Completado", previous: "Anterior", next: "Siguiente", language: "Idioma", saveNote: "Guardar nota", newScribble: "Nueva nota libre" };
