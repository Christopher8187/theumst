...
import { useDemoI18n, languageOptions } from '../i18n';
...
const en = {
  ...
  version:'Web Demo Version 0.0.7', progressLabel:'Completed', chapters:'chapters', fixtures:'Sample state',
};
const zh:typeof en = {
  ...
  version:'Web Demo 版本 0.0.7', progressLabel:'已完成', chapters:'章', fixtures:'示例状态',
};
const ja:typeof en = {
  ...
  version:'Web Demo バージョン 0.0.7', progressLabel:'完了', chapters:'章', fixtures:'サンプル状態',
};
const extra:Record<string,typeof en>={en,zh,ja};
const roundCopy:Record<string,Record<string,string>>={
  en:{retry:'Retry',type_context:'Context',type_definition:'Definition',type_theorem:'Theorem',type_example:'Example',type_exercise:'Exercise',type_proof:'Proof',type_lemma:'Lemma',type_proposition:'Proposition',type_corollary:'Corollary',cluster:'Find neighbors',folio:'Folio',contentsBeside:'Contents beside',sidePanel:'Side panel',topMenu:'Top menu',sideRail:'Side rail',bottomDock:'Bottom dock',actions:'Actions',acrossGrimoires:'Across grimoires',acrossReview:'Spaced repetition across your grimoires',acrossAdvice:'Revisit collected advice',acrossExpand:'Discover knowledge beyond your grimoires',acrossProgress:'Study statistics and longer-term planning',bookDetails:'Book details',read:'Read',backToTree:'Back to grimoires'},
  zh:{retry:'重试',type_context:'背景',type_definition:'定义',type_theorem:'定理',type_example:'例子',type_exercise:'习题',type_proof:'证明',type_lemma:'引理',type_proposition:'命题',type_corollary:'推论',cluster:'查找邻近知识',folio:'双页',contentsBeside:'侧边目录',sidePanel:'侧面板',topMenu:'顶部菜单',sideRail:'侧栏',bottomDock:'底部栏',actions:'功能',acrossGrimoires:'跨魔典',acrossReview:'跨魔典进行间隔复习',acrossAdvice:'回顾收集的建议',acrossExpand:'探索魔典之外的知识',acrossProgress:'学习统计与长期规划',bookDetails:'书籍信息',read:'阅读',backToTree:'返回魔典'},
  ja:{retry:'再試行',type_context:'背景',type_definition:'定義',type_theorem:'定理',type_example:'例',type_exercise:'演習',type_proof:'証明',type_lemma:'補題',type_proposition:'命題',type_corollary:'系',cluster:'近い知識を探す',folio:'見開き',contentsBeside:'目次を併置',sidePanel:'サイドパネル',topMenu:'上部メニュー',sideRail:'サイドバー',bottomDock:'下部ドック',actions:'機能',acrossGrimoires:'魔導書を横断',acrossReview:'魔導書を横断した間隔反復',acrossAdvice:'集めた助言を振り返る',acrossExpand:'魔導書の外の知識を探す',acrossProgress:'学習統計と長期計画',bookDetails:'書籍情報',read:'読む',backToTree:'魔導書に戻る'},
};
function createI18n(){
