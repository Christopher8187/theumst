...
<style scoped>
/* Keep the stage from intercepting covers behind its 3D plane. */
.orbit-volume-stage{pointer-events:none}
.orbit-volume-stage .orbit-book{pointer-events:auto}
.orbit-book>*{pointer-events:none}
