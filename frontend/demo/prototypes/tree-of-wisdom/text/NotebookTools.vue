...
const props = defineProps<{
  labels: { crystallization: string; dependencies: string; notes: string; cluster: string; train: string; book: string };
  sideMode: string;
...
const tools = computed(() => [
  ...
  { id: props.mode === 'questions' ? 'book' : 'train', label: props.mode === 'questions' ? props.labels.book : props.labels.train, path: props.mode === 'questions' ? 'M12 5C8 2 5 3 2 4v15c4-2 7-2 10 0 3-2 6-2 10 0V4c-3-1-6-2-10 1Zm0 0v14' : 'M12 3a9 9 0 1 0 9 9M12 7a5 5 0 1 0 5 5M12 12l9-9m-5 0h5v5', active: undefined },
]);
...
<style scoped>
.notebook-tools{display:flex;gap:5px;align-items:center;min-width:0;padding:0;position:relative;z-index:4}
...
.notebook-tooltip{position:absolute;left:0;bottom:calc(100% + 8px);padding:5px 9px;background:#173340f5;border:1px solid #b5d2d244;color:#dce7e4;font:12px/1.35 'Segoe UI',sans-serif;pointer-events:none;opacity:0;transition:opacity .12s;white-space:nowrap}
