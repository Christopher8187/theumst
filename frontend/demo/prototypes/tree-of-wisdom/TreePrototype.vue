...
function updateUrl(){
  ...
  query.set('prototype','wisdom');query.set('revision','14');query.delete('variant');query.delete('brief');query.delete('actions');query.set('place',place.value);query.set('view',scene.value);
