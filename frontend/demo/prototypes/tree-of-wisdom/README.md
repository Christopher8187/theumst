...
Open `http://127.0.0.1:5175/demo/?prototype=wisdom&revision=23&arrival=0&book=analysis`.
...
Revision 17 combines the two book header rows and places [zoom and the overview inside the graph](round-seventeen.md).
Revision 18 tightens [Atlas spacing and group outlines](round-eighteen.md).
...
Book details opens by default and shows Edition, ISBN, Objects and Chapters,
with progress beneath all four statistics. The completion bar also appears in the realm book's upper page margin
...
[the current round](round-twenty-three.md) for the selected notebook, and
