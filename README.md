...
Before publishing an update, follow [testing](docs/testing.md), [release identity](docs/releases.md) and [operations](docs/operations.md). COM and CN have independent data and settings. This delivery targets COM only and delivers Web Demo 0.0.7. [News subscriptions](docs/news-subscriptions.md) describes consent, announcement publication and delivery operation.
