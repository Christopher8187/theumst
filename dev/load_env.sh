...
export LOCAL_URL NGINX_USER BACKEND_PORT DASHBOARD_PORT BACKEND_SERVICE DB_NAME DB_USER DB_PASSWORD DB_HOST DB_PORT DASHBOARD_DIR LOCAL_STATE_DIR LOCAL_LOG_DIR LOCAL_NGINX_PREFIX LOCAL_NGINX_CONF LOCAL_NGINX_TEMPLATE LOCAL_STORAGE_DIR
...
export TARGET_SERVER SSH_KEY SSH_USER SSH_HOST REMOTE_ROOT NGINX_SITE NGINX_CONF REMOTE_URL DOMAIN CERT_NAME CERT_MODE SUDO_PASSWORD KEY REMOTE REMOTE_BACKEND REMOTE_DASHBOARD SUDO BACKEND_SERVICE
